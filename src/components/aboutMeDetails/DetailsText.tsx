const DetailsText = () => {
	return (
		<div className='my-4 max-w-[500px] lg:col-start-2 lg:col-end-3 text-center lg:text-[17px] lg:mt-0'>
			...
			<p className='my-6'>
				I’m an aspiring Junior Frontend Developer, aiming to become a Fullstack Developer. I’m motivated, hardworking,
				and eager to gain hands-on experience. I’m looking for a long-term opportunity where I can contribute to
				interesting projects, improve my skills, and grow as a developer. I work well both independently and as part of
				a team, and I enjoy solving problems and finding creative solutions.
			</p>
		</div>
	)
}
