...
const ProjectsCardItem: React.FC<ComponentType> = ({ title, description, tech, link }) => {
	return (
		<div className='flex flex-col justify-between gap-6 border border-hightlight  even:scale-110 border-1 max-w-[310px] 2xl:max-w-[330px] w-full text-center rounded-3xl bg-main p-6 sm:mt-8 hover:scale-[0.98] even:hover:scale-[1.08] duration-300'>
			<div>
